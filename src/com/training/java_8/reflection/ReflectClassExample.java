...
public class ReflectClassExample {
    ...
    public static void getClassInfo() throws ClassNotFoundException {
        Class<?> aClazz = Class.forName("com.training.java_8.reflection.Cat");
        ...
        // Lấy ra mảng các Interface mà Cat implements
        System.out.println("\nInterface:");
        ...
        for (Constructor<?> constructor : constructors) {
            System.out.println("+ " + constructor.getName() + " has " +
                    constructor.getParameterCount() + " param");
        }
